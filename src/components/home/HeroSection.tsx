            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
                    ...
                    <motion.div
                        ...
                        className="w-full lg:w-[45%] relative flex justify-center py-10 min-h-[500px]"
                    >
                        <LanguageSwitcher />

                        <div className="relative w-full max-w-[500px] aspect-square perspective-[2000px] perspective-origin-center">
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-64 h-64 bg-cascade-blue/5 border border-cascade-blue/20 rounded-3xl shadow-[0_0_50px_rgba(14,165,233,0.15)] backdrop-blur-sm"
                            />

                            {/* Middle Layer - Web Tech */}
                            <motion.div
                                initial={{ opacity: 0, rotateX: 60, rotateZ: -45, y: 50 }}
                                animate={{ opacity: 1, rotateX: 60, rotateZ: -45, y: -60 }}
                                whileHover={{ scale: 1.05, y: -70, boxShadow: "0 0 60px rgba(6,182,212,0.4)" }}
                                transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
                                className="absolute bottom-10 left-1/2 -translate-x-1/2 w-56 h-56 bg-gradient-to-tr from-cascade-cyan/10 to-transparent border border-cascade-cyan/30 rounded-3xl flex items-center justify-center backdrop-blur-md z-10 cursor-pointer"
                            >
                                <div className="absolute inset-0 bg-grid-overlay opacity-30 mask-image-radial z-0 pointer-events-none" />
                                <motion.div
                                    animate={{ y: [-5, 5, -5] }}
                                    transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                                    className="w-16 h-16 rounded-2xl bg-cascade-void shadow-[0_0_30px_rgba(6,182,212,0.3)] border border-cascade-cyan flex items-center justify-center rotate-45 pointer-events-none"
                                >
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-40 left-1/2 w-[2px] bg-gradient-to-t from-cascade-cyan/10 to-cascade-blue shadow-[0_0_10px_#0EA5E9] z-15"
                            />
                            ...
                            <Link to="/services" className="absolute bottom-10 left-1/2 z-20 group">
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, rotateX: 60, rotateZ: -45, y: -140 }}
                                    whileHover={{ scale: 1.05, y: -150, boxShadow: "0 0 60px rgba(14,165,233,0.5)" }}
                                    transition={{ duration: 0.8, delay: 0.5, ease: "easeOut" }}
                                    className="-translate-x-1/2 w-48 h-48 bg-gradient-to-tr from-cascade-blue/10 to-transparent border border-cascade-blue/40 rounded-3xl flex items-center justify-center backdrop-blur-lg cursor-pointer"
                                >
                                    <motion.div
                                        animate={{ y: [-5, 5, -5] }}
                                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                                        className="w-16 h-16 rounded-2xl bg-cascade-void shadow-[0_0_30px_rgba(14,165,233,0.4)] border border-cascade-blue flex items-center justify-center rotate-45 pointer-events-none"
                                    >
                            ...
                            <motion.div
                                ...
                                whileHover={{ scale: 1.1, x: -95, y: -105 }}
                            ...
                            >
                                <motion.div
                                    ...
                                    className="w-12 h-12 rounded-xl bg-cascade-void shadow-[0_0_30px_rgba(99,102,241,0.5)] border border-cascade-indigo flex items-center justify-center pointer-events-none"
                                >
                                    <Code2 size={20} className="text-cascade-indigo" />
                                </motion.div>
                                <motion.svg
                                    className="absolute top-full left-1/2 -translate-x-1/2 w-10 h-20 -z-10"
                                    initial={{ pathLength: 0, opacity: 0 }}
                                    animate={{ pathLength: 1, opacity: 1 }}
                                    transition={{ duration: 0.8, delay: 1 }}
                                >
                                    <path d="M 20 0 L 20 40 L 40 60" fill="none" stroke="url(#indigo-grad)" strokeWidth="2" strokeDasharray="4 4" />
                                    <defs>
